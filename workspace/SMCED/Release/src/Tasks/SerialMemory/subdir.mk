...
C_SRCS += \
../src/Tasks/SerialMemory/taskSerialMemory.c 

OBJS += \
./src/Tasks/SerialMemory/taskSerialMemory.o 

C_DEPS += \
./src/Tasks/SerialMemory/taskSerialMemory.d 


# Each subdirectory must supply rules for building sources it contributes
src/Tasks/SerialMemory/%.o: ../src/Tasks/SerialMemory/%.c
	@echo 'Building file: $<'
