...
C_SRCS += \
../src/Tasks/SdCard/option/syscall.c 

OBJS += \
./src/Tasks/SdCard/option/syscall.o 

C_DEPS += \
./src/Tasks/SdCard/option/syscall.d 


# Each subdirectory must supply rules for building sources it contributes
src/Tasks/SdCard/option/%.o: ../src/Tasks/SdCard/option/%.c
	@echo 'Building file: $<'
