...
C_SRCS += \
../src/Tasks/SdCard/lib_FatFS/src/option/cc932.c \
../src/Tasks/SdCard/lib_FatFS/src/option/syscall.c 

OBJS += \
./src/Tasks/SdCard/lib_FatFS/src/option/cc932.o \
./src/Tasks/SdCard/lib_FatFS/src/option/syscall.o 

C_DEPS += \
./src/Tasks/SdCard/lib_FatFS/src/option/cc932.d \
./src/Tasks/SdCard/lib_FatFS/src/option/syscall.d 


# Each subdirectory must supply rules for building sources it contributes
src/Tasks/SdCard/lib_FatFS/src/option/%.o: ../src/Tasks/SdCard/lib_FatFS/src/option/%.c
	@echo 'Building file: $<'
