...
#define SCS_Val               0x000000020 //Para habilitar oscilador externo
//#define SCS_Val               0x00000020
#define CLKSRCSEL_Val         0x000000001 //Fuente de clock para el pll (External 12MHz)
//#define CLKSRCSEL_Val         0x00000001
#define PLL0_SETUP            1
#define PLL0CFG_Val           0x00050063 //FCCO = 2*4MHz*39/1=312MHz
//#define PLL0CFG_Val           0x00050063
#define PLL1_SETUP            0
#define PLL1CFG_Val           0x00000023
#define CCLKCFG_Val           0x00000003 //CCLK = FCCO/6 = 52MHz
//#define CCLKCFG_Val           0x00000003
#define USBCLKCFG_Val         0x00000000
#define PCLKSEL0_Val          0x00000000 //Divisor del clock del ADC que sale del CPU seteado en 1
